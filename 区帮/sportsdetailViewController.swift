...
class sportsdetailViewController: UITableViewController,UITextFieldDelegate{
    ...
    func setupview(){
        ...
        let imageurl = sport?.salesimageurl
        imageview.loadimageusingcachewithurlstring(imageurl!)
        discribetextview.text = sport?.detaildiscribe
        namelabel.text = sport?.title
    }
