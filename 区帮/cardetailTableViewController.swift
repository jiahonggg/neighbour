...
class cardetailViewController: UITableViewController,UITextFieldDelegate{
    ...
    func setupview(){
        ...
        let imageurl = cars?.salesimageurl
        imageview.loadimageusingcachewithurlstring(imageurl!)
        discribetextview.text = cars?.detaildiscribe
        namelabel.text = cars?.title
    }
